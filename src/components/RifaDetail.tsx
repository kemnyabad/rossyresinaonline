...
const RifaDetail = ({ 
  ...
  // Bloqueo de Scroll 'Anti-Rebote' vinculado al estado del anuncio
  useEffect(() => {
    if (adActive) {
  ...
  if (adActive && selectedRifa.videoUrl) {
    return (
      <div 
        className="fixed inset-0 w-full h-[100dvh] bg-black z-[9999] m-0 p-0 border-none flex items-center justify-center overflow-hidden"
      ...
      >
        ...
        {showSkipButton && (
          <button
            ...
            className="fixed bottom-10 right-6 z-[10000] px-8 min-h-[48px] flex items-center justify-center bg-white text-[#6E2CA1] rounded-full font-black text-[12px] md:text-sm uppercase tracking-[0.2em] shadow-2xl hover:scale-105 transition-all duration-300 pointer-events-auto"
          >
