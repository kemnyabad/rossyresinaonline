...
import { ArrowLeftIcon, ShoppingCartIcon, TrophyIcon, InformationCircleIcon } from "@heroicons/react/24/outline";
    ...
    <div className="animate-in fade-in duration-500 py-8 px-4 md:px-6 max-w-7xl mx-auto mb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
        <div className="lg:col-span-7">
          <div className="relative rounded-[2.5rem] overflow-hidden bg-slate-50 border border-slate-100 aspect-[16/10] mb-6 shadow-2xl">
