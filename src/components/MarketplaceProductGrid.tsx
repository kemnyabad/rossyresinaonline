            ...
            return (
              ...
              >
                <div className="relative w-full overflow-hidden rounded-md bg-gray-50 pb-[100%]">
                  ...
                  />
                  <span className="absolute left-2 top-2 rounded-full bg-amazon_blue px-2 py-0.5 text-[10px] font-semibold uppercase text-white shadow-sm">
                    Vendedora
                  </span>
                </div>
                <div className="mt-2 flex flex-1 flex-col">
                  ...
                  <p className="mt-1 line-clamp-1 text-xs font-semibold text-gray-500">
                    {product.shop?.commercialName || "Emprendedora Rossy Resina"}
                  </p>
                  <div className="mt-2 flex items-end justify-between gap-2">
                    <p className="text-base font-semibold text-amazon_blue md:text-xl">
                      S/ {Number(product.price || 0).toFixed(2)}
                    </p>
                    <span className="rounded-full border border-pink-100 px-2 py-1 text-[11px] font-semibold text-gray-600">
                      WhatsApp
                    </span>
                  </div>
                </div>
