        ...
        <section className="space-y-6">
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="mt-5 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div className="border border-gray-200 rounded-lg p-4 text-center">Creditos</div>
            </div>
            <div className="mt-4">
              <button
                type="button"
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div className="border border-gray-200 rounded-lg p-4 text-center">Pendientes de envio</div>
