    ...
    <div className="max-w-screen-2xl mx-auto px-6 py-8">
      ...
      <header className="rounded-lg bg-amazon_blue text-white p-6 shadow">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <Link
            ...
            className="inline-block px-4 py-2 rounded bg-white/20 backdrop-blur hover:bg-white/30 text-white font-semibold text-sm"
          >
            Ver resinas
          </Link>
        </div>
      ...
      <section className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 rounded-lg p-6 bg-white shadow border border-gray-200">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link href="/categoria/resina" className="rounded-lg p-4 bg-amazon_blue text-white shadow hover:bg-amazon_yellow hover:text-black">
              Resinas epoxi y UV
            </Link>
            <Link href="/categoria/moldes-de-silicona" className="rounded-lg p-4 bg-amazon_blue text-white shadow hover:bg-amazon_yellow hover:text-black">
              Moldes de silicona
            </Link>
            <Link href="/categoria/pigmentos" className="rounded-lg p-4 bg-amazon_blue text-white shadow hover:bg-amazon_yellow hover:text-black">
              Pigmentos y glitter
            </Link>
            <Link href="/categoria/accesorios" className="rounded-lg p-4 bg-amazon_blue text-white shadow hover:bg-amazon_yellow hover:text-black">
              Accesorios
            </Link>
          </div>
        </div>
        <aside className="rounded-lg p-6 bg-white shadow border border-gray-200">
          ...
          <ul className="mt-2 grid gap-2 text-sm text-gray-700">
            <li>Entrega rpida y soporte por WhatsApp.</li>
            <li>Materiales probados y fichas tcnicas claras.</li>
      ...
      <section className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-lg p-6 bg-white shadow border border-gray-200">
          ...
          <p className="text-sm text-gray-700 mt-1">Aprende resina desde cero o perfecciona tcnicas avanzadas.</p>
          <Link href="/categoria/talleres" className="mt-3 inline-block px-4 py-2 rounded bg-amazon_blue text-white hover:bg-amazon_yellow hover:text-black text-sm">
            Ver talleres
          </Link>
        </div>
        <div className="rounded-lg p-6 bg-white shadow border border-gray-200">
        ...
        <div className="rounded-lg p-6 bg-white shadow border border-gray-200">
          ...
          <Link href="/contact" className="mt-3 inline-block px-4 py-2 rounded bg-amazon_blue text-white hover:bg-amazon_yellow hover:text-black text-sm">
            Ir a contacto
          </Link>
        </div>
      </section>
