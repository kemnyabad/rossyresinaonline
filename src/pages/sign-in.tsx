    ...
    <div className="min-h-[70vh] flex items-center justify-center px-6 py-12 bg-gradient-to-b from-gray-100 to-transparent">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow border border-gray-200 p-8">
        ...
        <div className="mt-6 grid gap-3">
          ...
          <div className="grid gap-2">
            {mode === "login" && isLocalhost && (
              <button
                ...
                className="w-full rounded-md border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-black text-emerald-800 hover:bg-emerald-100"
              >
                Usar cuenta local de prueba
              </button>
            )}
            {mode === "register" && (
          ...
          {isLocalhost ? (
            <p className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-center text-xs font-semibold text-amber-800">
              Google esta desactivado en localhost. Usa la cuenta local de prueba.
            </p>
          ) : (
            <button
